...
name_urls = [base_url] + [base_url[:-1] + str(int(20 * (i - 1))) for i in range(2, num_pages + 1)]
path = r'C:/Users/Shasa/Documents/Projects/bitcointalk_ANN/bitcointalk_ANN/spiders/name_urls.pkl'
output = open(path, 'wb')
